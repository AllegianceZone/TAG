...
namespace FreeAllegiance.Tag
{
	...
	public class ServiceInstaller
	{
		...
		public static bool InstallService (string svcPath, string svcName, string svcDispName, string svcDependancies)
		{
			...
			try
			{
				...
				{
					IntPtr sv_handle = CreateService(sc_handle, svcName, svcDispName, SERVICE_ALL_ACCESS, SERVICE_WIN32_OWN_PROCESS, SERVICE_AUTO_START, SERVICE_ERROR_NORMAL, svcPath, null, 0, svcDependancies, null, null);
